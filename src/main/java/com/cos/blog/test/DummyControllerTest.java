...
// html파일이 아니라 data를 리턴해주는 controoler = Restcontroller
@RestController
public class DummyControllerTest {
	...
	public User detail(@PathVariable int id) {
		...
		// 그럼 return 할때null이 return이 되잖아.. 그럼 프로그램에 문제가 있지 않겠니?
		// Optional로 너의 User객체를 감싸서 가져올테니 null인지 아닌지 판단해서 알아서 return해!!!!!
...
//		});
	...
	// http의 body에 username, password, email data를 가지고 (요청)
